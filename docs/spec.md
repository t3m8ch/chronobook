...
5. Если уведомление попадает в запрещённое время, то используется умная логика:
   - Если до услуги больше 12 часов → отправить после окончания тихих часов
   - Если до услуги меньше 12 часов → отправить до начала тихих часов  
   - Если до услуги меньше 2-3 часов → отправить немедленно (критическое уведомление)
   - Граница в 12 часов настраивается на уровне филиала
